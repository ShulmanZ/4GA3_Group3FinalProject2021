...
Neighbourbounds <- Neighbourbounds %>%
  mutate(sma = lag.listw(Neighbourbounds.w, MH_PC_Tot))

simulation_1 <- sample(Neighbourbounds$MH_PC_Tot)
simulation_1.sma <- lag.listw(Neighbourbounds.w, simulation_1)
simulation_2 <- sample(Neighbourbounds$MH_PC_Tot)
simulation_2.sma <- lag.listw(Neighbourbounds.w, simulation_2)
simulation_3 <- sample(Neighbourbounds$MH_PC_Tot)
simulation_3.sma <- lag.listw(Neighbourbounds.w, simulation_3)
simulation_4 <- sample(Neighbourbounds$MH_PC_Tot)
simulation_4.sma <- lag.listw(Neighbourbounds.w, simulation_4)
simulation_5 <- sample(Neighbourbounds$MH_PC_Tot)
