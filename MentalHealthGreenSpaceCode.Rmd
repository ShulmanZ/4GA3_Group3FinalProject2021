...
```{r Linear-Regression-Final,echo=FALSE, fig.cap={"\\label{fig:LR-Final}The relationship between mental health determinants and study variables (including green space avaliability within 5 minute walking distance) of neighbourhoods and mental health related hosptial admissions"}}
#Model with everything
model <- lm(formula = MH_PC_Tot ~Area_5_Transform * Unemploy_r * Prop_Alone * PropAge65Plus * Med_Ind_In *Prop_Immigrants, data = Neighbourbounds)
...
```{r}
#Model with everything
testmodel <- lm(formula = MH_PC_Tot ~Unemploy_r * Prop_Alone * PropAge65Plus * Med_Ind_In *Prop_Immigrants, data = Neighbourbounds)
...
>>>>>>> 0aece65abb06f1a36c580341770fb5e24513703e
